...
{
    [TestFixture]
    public class ForexFillModelTests
    {
        ...
        {
            var model = new ForexFillModel();
            var order = new MarketOrder(Symbols.EURUSD, 100, Noon);
            var config = CreateQuoteBarConfig(Symbols.EURUSD);
            var security = CreateSecurity(config);
            security.SetLocalTimeKeeper(TimeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(Noon, Symbols.EURUSD,
        ...
        {
            var model = new ForexFillModel();
            var order = new LimitOrder(Symbols.EURUSD, 100, 101.5m, Noon);
            var configQuoteBar = CreateQuoteBarConfig(Symbols.EURUSD);
            ...
            security.SetMarketPrice(new TradeBar(Noon, Symbols.EURUSD, 102m, 103m, 101m, 102.3m, 100));
        ...
        public void PerformsLimitFillSell()
        {
            var model = new ForexFillModel();
            var order = new LimitOrder(Symbols.EURUSD, -100, 101.5m, Noon);
            var configTradeBar = CreateQuoteBarConfig(Symbols.EURUSD);
            ...
            var quoteBar = new QuoteBar(Noon, Symbols.EURUSD,
        ...
        {
            var model = new ForexFillModel();
            var order = new StopLimitOrder(Symbols.EURUSD, 100, 101.5m, 101.75m, Noon);
            var configQuoteBar = CreateQuoteBarConfig(Symbols.EURUSD);
            var security = CreateSecurity(configQuoteBar);
            security.SetLocalTimeKeeper(TimeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(Noon, Symbols.EURUSD,
            ...
            security.SetMarketPrice(new QuoteBar(Noon.AddMinutes(1), Symbols.EURUSD,
                new Bar(102m, 102m, 102m, 102m), 100,
                new Bar(102m, 102m, 102m, 102m), 100));
            ...
            security.SetMarketPrice(new QuoteBar(Noon.AddMinutes(2), Symbols.EURUSD,
                new Bar(101m, 102m, 100m, 100.66m), 100,
                new Bar(103m, 104m, 102m, 102.66m), 100));
            security.SetMarketPrice(new TradeBar(Noon.AddMinutes(3), Symbols.EURUSD, 102m, 103m, 101m, 101.66m, 100));
        ...
        {
            var model = new ForexFillModel();
            var order = new StopLimitOrder(Symbols.EURUSD, -100, 101.75m, 101.50m, Noon);
            var configQuoteBar = CreateQuoteBarConfig(Symbols.EURUSD);
            var security = CreateSecurity(configQuoteBar);
            security.SetLocalTimeKeeper(TimeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(Noon, Symbols.EURUSD,
        ...
        {
            var model = new ForexFillModel();
            var order = new StopMarketOrder(Symbols.EURUSD, 100, 101.5m, Noon);
            var configQuoteBar = CreateQuoteBarConfig(Symbols.EURUSD);
            var security = CreateSecurity(configQuoteBar);
            security.SetLocalTimeKeeper(TimeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(Noon, Symbols.EURUSD,
            ...
            security.SetMarketPrice(new TradeBar(Noon, Symbols.EURUSD, 102m, 103m, 101m, 102.5m, 100));
        ...
        public void PerformsStopMarketFillSell()
        {
            ...
            security.SetMarketPrice(new TradeBar(Noon, Symbols.EURUSD, 102m, 103m, 101m, 101m, 100));
        ...
        public void PerformsMarketOnOpenUsingOpenPrice()
        {
            ...
            security.SetMarketPrice(new QuoteBar(time, Symbols.EURUSD,
                new Bar(1m, 2m, 0.5m, 1.33m), 100,
                new Bar(1m, 2m, 0.5m, 1.33m), 100));

            Assert.Throws<NotSupportedException>(() =>
                new ForexFillModel().Fill(
                    new FillModelParameters(
                        security,
                        new MarketOnOpenOrder(Symbols.EURUSD, 100, reference),
        ...
        public void PerformsMarketOnCloseUsingClosingPrice()
        {
            ...
            var time = reference;
            TimeKeeper.SetUtcDateTime(time.ConvertToUtc(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(time - configQuoteBar.Increment, Symbols.EURUSD,
                new Bar(1m, 2m, 0.5m, 1.33m), 100,
            ...
            Assert.Throws<NotSupportedException>(()=>
                new ForexFillModel().Fill(
                    new FillModelParameters(
                        security,
                        new MarketOnCloseOrder(Symbols.EURUSD, 100, reference),
                        new MockSubscriptionDataConfigProvider(configQuoteBar),
                        Time.OneHour
                    )
                )
        ...
        public void ImmediateFillModelUsesPriceForTicksWhenBidAskSpreadsAreNotAvailable()
        {
            ...
            var config = new SubscriptionDataConfig(typeof(Tick), Symbols.EURUSD, Resolution.Tick, TimeZones.NewYork, TimeZones.NewYork, true, true, false);
            var security = CreateSecurity(config);
            security.SetLocalTimeKeeper(timeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(noon, Symbols.EURUSD,
                new Bar(101.123m, 101.123m, 101.123m, 101.123m), 100,
            ...
            security.Cache.AddData(new QuoteBar(DateTime.MinValue, Symbols.EURUSD,
                new Bar(1.0m, 1.0m, 1.0m, 1.0m), 1.0m,
                new Bar(1.0m, 1.0m, 1.0m, 1.0m), 1.0m));
            security.Cache.AddData(new Tick(config, "42525000,1000000,100,A,@,0", DateTime.MinValue));

            var fillModel = new ForexFillModel();
            var order = new MarketOrder(Symbols.EURUSD, 1000, DateTime.Now);
            var fill = fillModel.Fill(new FillModelParameters(
                security,
                order,
                new MockSubscriptionDataConfigProvider(config),
        ...
        public void StopMarketOrderDoesNotFillUsingDataBeforeSubmitTime(decimal orderQuantity, decimal stopPrice)
        {
            ...
            var quoteBar = new QuoteBar(time, Symbols.EURUSD,
                new Bar(290m, 292m, 289m, 291m), 12345,
                new Bar(290m, 292m, 289m, 291m), 12345);
            security.SetMarketPrice(quoteBar);
            ...
            var fillModel = new ForexFillModel();
            var order = new StopMarketOrder(Symbols.EURUSD, orderQuantity, stopPrice, time.ConvertToUtc(TimeZones.NewYork));
            ...
            quoteBar = new QuoteBar(time, Symbols.EURUSD,
                new Bar(290m, 292m, 289m, 291m), 12345,
                new Bar(290m, 292m, 289m, 291m), 12345);
            security.SetMarketPrice(quoteBar);
        ...
        public void StopLimitOrderDoesNotFillUsingDataBeforeSubmitTime(decimal orderQuantity, decimal stopPrice, decimal limitPrice)
        {
            ...
            var fillModel = new ForexFillModel();
            var order = new StopLimitOrder(Symbols.EURUSD, orderQuantity, stopPrice, limitPrice, time.ConvertToUtc(TimeZones.NewYork));
        ...
        {
            var model = new ForexFillModel();
            var order = new StopMarketOrder(Symbols.EURUSD, orderQuantity, 101.5m, Noon);
            var configTick = new SubscriptionDataConfig(typeof(Tick), Symbols.EURUSD, Resolution.Tick, TimeZones.NewYork, TimeZones.NewYork, true, true, false);
            ...
            security.SetMarketPrice(new Tick(Noon, Symbols.EURUSD, 101.5m, 101.5m, 101.5m));
            ...
            security.Update(new[] { new OpenInterest(Noon, Symbols.EURUSD, openInterest) }, typeof(Tick));
        ...
        {
            var model = new ForexFillModel();
            var order = new MarketOrder(Symbols.EURUSD, -100, Noon.ConvertToUtc(TimeZones.NewYork).AddMinutes(61));
            var config = CreateQuoteBarConfig(Symbols.EURUSD);
            var security = CreateSecurity(config);
            security.SetLocalTimeKeeper(TimeKeeper.GetLocalTimeKeeper(TimeZones.NewYork));
            security.SetMarketPrice(new QuoteBar(Noon, Symbols.EURUSD,
