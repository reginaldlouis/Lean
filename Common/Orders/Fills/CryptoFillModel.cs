...
{
    /// <summary>
    /// Implements <see cref="IFillModel"/> for Crypto
    /// </summary>
    public class CryptoFillModel : FillModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Market on Open fill model for Crypto.
        /// </summary>
        ...
        /// <summary>
        /// Market on Close fill model for Crypto.
        /// </summary>
        /// <param name="asset">Asset we're trading with this order</param>
        /// <param name="order">Order to be filled</param>
        /// <returns>Order fill information detailing the average price and quantity filled.</returns>
        ...
        private Bar GetLastBar(Security asset, out DateTime endTime)
        {
            ...
            if (subscribedTypes.Contains(typeof(Tick)))
            {
                var trade = asset.Cache.GetData<Tick>();
                if (trade != null)
                {
